...
#remember, string is list-like, so can loop through each character like this
for character in message.upper(): #upper makes all uppercase 
    count.setdefault(character, 0) #if key does not exist, add it to dict and value 0
    count[character] = count[character] + 1

print(count)
pprint.pprint(count) #prints sorted, 1 value per column

rjtext = pprint.pformat(count) #saves the dictionary as a string!
print(rjtext) #can choose to print the string out(like pprint.pprint), or do something else with it